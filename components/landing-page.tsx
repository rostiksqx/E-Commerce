...
export default function LandingPage() {
  return (
    ...
    >
      <div className="max-w-[577px] space-y-8 z-10 max-md:space-y-0">
      ...
      <div className="flex flex-wrap items-center space-x-8 z-10 max-md:space-x-[27.5px] max-md:justify-center">
        <div>
